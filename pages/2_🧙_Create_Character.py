...
# load JSON data
# load the npc creator data from JSON file
with open('data/characters/create.json', 'r') as f:
...
create_tab, dialogue_tab, sprite_tab = st.tabs(["🧙Create Character", "💬Dialogue Trees", "👾Spritesheet"])

with create_tab:
    st.subheader("Create NPC Character:")
...
with dialogue_tab:
    ...
    with open('data/characters/dialogue.json', 'r') as file:
...
with sprite_tab:
    ...
    st.subheader("Sprites Asset Library:")
    st.image('./assets/images/wizard.png', caption="Wizard Spritesheet")
